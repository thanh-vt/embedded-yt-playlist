...
Contributors: thanh-vt
Donate link:
Tags: youtube, playlist, subscription, 3d, slider
...
* [Github Repository](https://github.com/thanh-vt/embedded-yt-playlist)

== Installation ==

Upload the "Embedded Youtube Playlist" to plugin directory and Activate it.
Use shortcode to display:
[embedded_yt_playlist_app playlistid="<Your Youtube playlist ID>" channelid="<Your Youtube channel ID>"]
